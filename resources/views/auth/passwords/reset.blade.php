                    ...
                    <form method="POST" action="{{ route('password.update') }}">
                        @csrf
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" id="default-01" value="{{ $email ?? old('email') }}"  placeholder="Enter your email address">
